...
from tensorflow.python.keras.layers import Add, Conv2D, Input, Lambda, Dropout
from tensorflow.python.keras.models import Model

from model.common import normalize, denormalize, pixel_shuffle


def wdsr_bnn(scale, num_filters=32, num_res_blocks=8, res_block_expansion=6, res_block_scaling=None, p=0.5, nchan=1):
